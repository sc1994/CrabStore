...
namespace DAL
{
    ...
    public partial class CsOrderDal : ICsOrderDal
    {
        ...
        public int Add(CsOrder model)
        {
            ...
            strSql.Append("OrderNumber,UserId,TotalMoney,DiscountMoney,ActualMoney,OrderDate,OrderState,RowStatus,DeleteDate,DeleteDescribe");
        ...
        public bool Update(CsOrder model)
        {
            ...
            strSql.Append("OrderNumber = @OrderNumber,UserId = @UserId,TotalMoney = @TotalMoney,DiscountMoney = @DiscountMoney,ActualMoney = @ActualMoney,OrderDate = @OrderDate,OrderState = @OrderState,RowStatus = @RowStatus,DeleteDate = @DeleteDate,DeleteDescribe = @DeleteDescribe");
