...
namespace DAL
{
    ...
    public partial class CsOrderDal : ICsOrderDal
    {
        ...
        public int Add(CsOrder model)
        {
            ...
            strSql.Append("OrderNumber,UserId,TotalMoney,DiscountMoney,ActualMoney,OrderDate,OrderState,OrderAddress,OrderDelivery,RowStatus,DeleteDate,DeleteDescribe,OrderCopies,CargoNumber,SendAddress");
